function githubicon(props = { text, to }) {
    return (
        <div className='githubicon'>
        <a href="https://github.com/alongw/uptime-status-web" className="github-corner" aria-label="View source on GitHub" target='_blank'>
